...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help="Single end read file(s) for analyzing (may be gzipped)",
    )
    parser.add_argument(
        "--input_pe",
        nargs="+",
        type=str,
        required=False,
        help="Paired end read files for analyzing (may be gzipped)",
    )
    parser.add_argument(
        "--merge_paired",
        action="store_true",
        required=False,
        help="Switch on if you want to merge their data to get a single result",
    )
    parser.add_argument(
        "--forward",
        type=str,
        required=False,
        default="_1",
        help="Designator for forward reads, otherwise default is _1, i.e. expect forward reads as sample_1.fastq.gz",
    )
    parser.add_argument(
        "--reverse",
        type=str,
        required=False,
        default="_2",
        help="Designator for reverse reads, otherwise default is _2, i.e. expect forward reads as sample_2.fastq.gz",
    )
    parser.add_argument(
        "--read_type",
        type=str,
    ...
    parser.add_argument(
        ...
        action="store_true",
        required=False,
        help="Report the consensus allele for the most likely allele.",
    )
